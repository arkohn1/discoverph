...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal('Add New Agency Type',"agency_types/manage_agency_type.php")
		})
		$('.edit_data').click(function(){
			uni_modal('Update Agency Type',"agency_types/manage_agency_type.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Agency Type permanently?","delete_shop_type",[$(this).attr('data-id')])
		})
