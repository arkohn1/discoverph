<?php 
if(isset($_GET['id'])){
	$vendor = $conn->query("SELECT * FROM agency_list where id ='".$_GET['id']."'");
	if($vendor->num_rows > 0){
		...
		echo '<script> alert("Unknown Vendor"); location.replace("./?page=agencies")</script>';
	}
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="agency_name" class="control-label">Travel Agency Name</label>
							<input type="text" id="agency_name" autofocus name="agency_name" class="form-control form-control-sm form-control-border" value="<?= isset($agency_name) ? $agency_name : "" ?>" required>
						</div>
						<div class="form-group col-md-6">
							<label for="agency_owner" class="control-label">Travel Agency Owner Fullname</label>
							<input type="text" id="agency_owner" name="agency_owner" class="form-control form-control-sm form-control-border" value="<?= isset($agency_owner) ? $agency_owner : "" ?>" required>
						</div>
						<div class="form-group col-md-6">
