        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `agency_list` where delete_flag = 0 order by agency_name asc ");
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=agencies/manage_agency&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Travel Agency permanently?","delete_vendor",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
