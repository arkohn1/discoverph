              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>vendor/?page=inquiries" class="nav-link nav-inquiries">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>vendor/?page=reviews" class="nav-link nav-reviews">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>vendor/?page=payments" class="nav-link nav-payments">
