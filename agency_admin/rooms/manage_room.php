...
<style>
    .warning-container {
        display: flex;
        align-items: center;
        margin-top: 2px; /* Add some space between the label and the warning text */
    }

    .warning-text {
        color: #721c24; /* Text color for warning */
        margin-left: 5px; /* Add some space between the icon and the text */
    }

    .caution-icon {
        color: #ffc107; /* Adjust the color of the caution icon */
        font-size: 1em; /* Adjust the font size of the caution icon */
    }
</style>
...
<div class="container-fluid">
	<form action="" id="room-form">
		...
		<div class="form-group">
			<label for="name" class="control-label">Seat Number</label>
		...
		<div class="form-group">
   			 <label for="package_category" class="control-label">
				Package Category
				<small class="warning-text">
					<i class="fas fa-exclamation-triangle caution-icon" title="Caution:"></i>
					Select a Package Category from Travel Categories
				</small>
			</label>
			<textarea name="package_category" id="package_category" rows="4" class="form-control form-control-sm rounded-0" required><?php echo isset($package_category) ? $package_category : ''; ?></textarea>
		</div>
		<div class="form-group">
			<label for="description" class="control-label">Seat Description</label>
		...
		<div class="form-group">
			...
			<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Taken</option>
			</select>
		</div>
