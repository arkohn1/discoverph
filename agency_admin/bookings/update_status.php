...
<div class="container-fluid">
    <form action="" id="update_status">
        ...
        <div class="form-group">
            <label for="status" class="control-label">Booking Status</label>
            <select name="status" id="status" class="form-control rounded-0" required>
                ...
                <option <?= isset($status) && $status == 2 ? 'selected' : '' ?> value="2">Done</option>
                <option <?= isset($status) && $status == 3 ? 'selected' : '' ?> value="3">Cancelled</option>
            </select>
        </div>
    </form>
</div>
