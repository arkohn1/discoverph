...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal('Add New Package',"packages/manage_package.php",'large')
		})
		$('.view_data').click(function(){
			uni_modal('View Package Details',"packages/view_package.php?id="+$(this).attr('data-id'),'large')
		})
		$('.edit_data').click(function(){
			uni_modal('Update Package',"packages/manage_package.php?id="+$(this).attr('data-id'),'large')
		})
